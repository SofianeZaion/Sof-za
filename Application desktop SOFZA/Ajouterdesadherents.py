...
class AjouterDesadherents:  # classe formulaire:
    def __init__(self,root):                   
        ...
        self.Paneaugrisdegestionlivres = Frame(self.PageAjouterDesAdherents, bg="#9D7B7F")
        self.Paneaugrisdegestionlivres.place(x=190, y=0, width=1100, height=1000)

        Paneaumarrondegestionlivres = Frame(self.PageAjouterDesAdherents, bg="#8E7E23")
        ...
        self.BoutonImageGestionlivres = Button(self.PageAjouterDesAdherents,cursor="hand2",command=self.Versgestionlivres, text="",image=self.ImageGestionlivres, width=184,height=90, bg="#8E7E23",font="arial 12 bold")
        self.BoutonImageGestionlivres.place(x=0 , y=0) 
        
        self.ImageAdherents = PhotoImage(file="Images/Adherents.png")
        self.BoutonImageAdherents = Button(self.PageAjouterDesAdherents,cursor="hand2",command=self.VersPageAdherents, text="",image=self.ImageAdherents, width=184, height=90, bg="#8E7E23",font="arial 12 bold")
        self.BoutonImageAdherents.place(x=0 , y=140) 

        self.ImageGestiondesprets = PhotoImage(file="Images/Emprunter.png")
        self.BoutonImageGestiondesprets = Button(self.PageAjouterDesAdherents,cursor="hand2",command=self.Versgestiondesprets, text="",image=self.ImageGestiondesprets, width=184, height=90, bg="#8E7E23",font="arial 12 bold")
        self.BoutonImageGestiondesprets.place(x=0 , y=280) 

        self.ImageSedeconnecter = PhotoImage(file="Images/Sedeconnecter.png")
        self.BoutonImageSedeconnecter = Button(self.PageAjouterDesAdherents,cursor="hand2",command=self.PourSedeconnecter, text="",image=self.ImageSedeconnecter, width=184, height=90, bg="#8E7E23",font="arial 12 bold")
        self.BoutonImageSedeconnecter.place(x=0 , y=420)

        titresgestionlivretitre = Label(self.PageAjouterDesAdherents, text=" Ajout d'adhérents ",font =("algarian", 20,"bold"), bg="#8E7E23", fg="black")
        titresgestionlivretitre.place(x=350, y=20,width=500)

        titresgestionlivres = Label(self.PageAjouterDesAdherents, text=" Livres ",font =("algarian", 15,"bold"), bg="#8E7E23", fg="black")
        titresgestionlivres.place(x=0, y=100,width=190)

        titresadherents = Label(self.PageAjouterDesAdherents, text="Adhérents",font =("algarian", 15,"bold"), bg="#8E7E23", fg="black")
        titresadherents.place(x=0, y=240,width=190)

        titresgestionprets = Label(self.PageAjouterDesAdherents, text=" Prêts",font =("algarian", 15,"bold"), bg="#8E7E23", fg="black")
        titresgestionprets.place(x=0, y=380,width=190)

        titressedeconnecter = Label(self.PageAjouterDesAdherents, text=" Se déconnecter",font =("algarian", 15,"bold"), bg="#8E7E23", fg="black")
        ...
        titrenom = Label(self.PageAjouterDesAdherents, text=" Nom ",font =("algarian", 12,"bold"), bg="#8E7E23", fg="black")
        titrenom.place(x=300, y=150,width=100)

        titreauteurs = Label(self.PageAjouterDesAdherents, text=" Prénom ",font =("algarian", 12,"bold"), bg="#8E7E23", fg="black")
        titreauteurs.place(x=310, y=200,width=100)

        titrecodepostal = Label(self.PageAjouterDesAdherents, text=" Code postal ",font =("algarian", 12,"bold"), bg="#8E7E23", fg="black")
        titrecodepostal.place(x=323, y=240,width=100)

        titreville= Label(self.PageAjouterDesAdherents, text=" Ville ",font =("algarian", 12,"bold"), bg="#8E7E23", fg="black")
        ...
        # bouton
        BoutonAjouterUnAdherent = Button(self.PageAjouterDesAdherents, command=self.ClickBoutonAjouterUnAdherent, text="Ajouter un adhérent",cursor="hand2", font=("times new roman",11), bd=0,bg="#8E7E23",fg="black")
