...
class adherents:  #classe formulaire:
    def __init__(self,root):                   
        ...
        self.Paneaugrisdegestionlivres = Frame(self.PageAdherents, bg="#9D7B7F")
        self.Paneaugrisdegestionlivres.place(x=190, y=0, width=1100, height=1000)

        Paneaumarrondegestionlivres = Frame(self.PageAdherents, bg="#8E7E23")
        ...
        self.BoutonGestionLivres = Button(self.PageAdherents,cursor="hand2", command=self.VersGestionsLivres,text="",image=self.ImageGestionlivres, width=184,height=90, bg="#ff7f00",font="arial 12 bold")
        self.BoutonGestionLivres.place(x=0 , y=0) 
        
        self.ImageAdherents = PhotoImage(file="Images/Adherents.png")
        self.BoutonImageAdherent = Button(self.PageAdherents, text="",cursor="hand2",image=self.ImageAdherents, width=184, height=90, bg="#ff7f00",font="arial 12 bold")
        self.BoutonImageAdherent.place(x=0 , y=140) 

        self.ImageGestionDesPrets = PhotoImage(file="Images/Emprunter.png") 
        self.BoutonImageGestionDesPrets = Button(self.PageAdherents,cursor="hand2", command=self.VersGestionsdesPrets,text="",image=self.ImageGestionDesPrets, width=184, height=90, bg="#8E7E23",font="arial 12 bold")
        self.BoutonImageGestionDesPrets.place(x=0 , y=280) 

        self.ImageSedeconnecter = PhotoImage(file="Images/Sedeconnecter.png")
        self.BoutonImageSedeconnecter = Button(self.PageAdherents,cursor="hand2", text="",command=self.PourSeDeconnecter,image=self.ImageSedeconnecter, width=184, height=90, bg="#8E7E23",font="arial 12 bold")
        ...
        #Titres
        titreGestionAdherentsDeLaPageAdherents = Label(self.PageAdherents, text=" Gestion Adhérents ",font =("algarian", 20,"bold"), bg="#8E7E23", fg="black")
        titreGestionAdherentsDeLaPageAdherents.place(x=350, y=20,width=500)
        
        titreGestionlivres = Label(self.PageAdherents, text=" Livres ",font =("algarian", 15,"bold"), bg="#8E7E23", fg="black")
        titreGestionlivres.place(x=0, y=100,width=190)

        titreGestionAdherentsDeLaPageAdherents = Label(self.PageAdherents, text=" Adhérents ",font =("algarian", 15,"bold"), bg="#8E7E23", fg="black")
        titreGestionAdherentsDeLaPageAdherents.place(x=0, y=240,width=190)

        titreGestionDesPretsDeLaPageAdherents = Label(self.PageAdherents, text=" Prêts",font =("algarian", 15,"bold"), bg="#8E7E23", fg="black")
        titreGestionDesPretsDeLaPageAdherents.place(x=0, y=380,width=190)

        titreSedeconnecterDeLaPageAdherents = Label(self.PageAdherents, text=" Se déconnecter",font =("algarian", 15,"bold"), bg="#8E7E23", fg="black")
        titreSedeconnecterDeLaPageAdherents.place(x=0, y=520,width=190)

        titreRechercherlesadherentspar = Label(self.PageAdherents, text=" Rechercher les adhérents par :",font =("algarian", 12,"bold"), bg="#8E7E23", fg="black")
        titreRechercherlesadherentspar.place(x=210, y=90,width=250)

        #Boutons
        BoutonAjouterunAdherentDeLaPageAdherents = Button(self.PageAdherents, text="Ajouter un adhérent",command=self.AllerVersLaPagePourAjouterdesadherents,cursor="hand2", font=("times new roman",11), bd=0,bg="#8E7E23",fg="black")
        BoutonAjouterunAdherentDeLaPageAdherents.place(x=215, y=500)

        BoutonSupprimerAdherentDeLaPageAdherents = Button(self.PageAdherents, command=self.SupprimerunAdherent,text="Supprimer un adhérent",cursor="hand2", font=("times new roman",11), bd=0,bg="#8E7E23",fg="black")
        BoutonSupprimerAdherentDeLaPageAdherents.place(x=890, y=500)

        BoutonPourRechercherUnLivre = Button(self.PageAdherents,command=self.ClickBoutonRechercher, text=" Rechercher  ",cursor="hand2", font=("times new roman",11), bd=0,bg="#8E7E23",fg="black")
        BoutonPourRechercherUnLivre.place(x=730, y=90) # command est attribuer a un bouton pour pouvoir l'executer

        BoutonActualiser = Button(self.PageAdherents,command=self.ClickBoutonActualiser, text="Actualiser ",cursor="hand2", font=("times new roman",11), bd=0,bg="#8E7E23",fg="black")
