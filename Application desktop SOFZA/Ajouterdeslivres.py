...
class AjoutLivres:  # 
    def __init__(self,root):                   
        ...
        self.Paneaugrisdegestionlivres = Frame(self.PageAjouterDesLivres, bg="#9D7B7F")
        self.Paneaugrisdegestionlivres.place(x=190, y=0, width=1100, height=1000)

        #Panneau orange gestion livres
        Paneaumarrondegestionlivres = Frame(self.PageAjouterDesLivres, bg="#8E7E23")
        ...
        self.BoutonImagesGestionlivre = Button(self.PageAjouterDesLivres,cursor="hand2",command=self.VersGestionlivres, text="",image=self.ImageGestionlivres, width=184,height=90, bg="#8E7E23",font="arial 12 bold")
        self.BoutonImagesGestionlivre.place(x=0 , y=0) 
        
        self.ImageAdherents = PhotoImage(file="Images/Adherents.png")
        self.BoutonImageAdherents = Button(self.PageAjouterDesLivres,cursor="hand2",command=self.VersAdherents ,text="",image=self.ImageAdherents, width=184, height=90, bg="#8E7E23",font="arial 12 bold")
        self.BoutonImageAdherents.place(x=0 , y=140) 

        self.ImageEmprunter = PhotoImage(file="Images/Emprunter.png")
        self.BoutonImageEmprunter = Button(self.PageAjouterDesLivres,cursor="hand2",command=self.VersGestiondesprets, text="",image=self.ImageEmprunter, width=184, height=90, bg="#8E7E23",font="arial 12 bold")
        self.BoutonImageEmprunter.place(x=0 , y=280) 

        self.ImageSedeconnecter = PhotoImage(file="Images/Sedeconnecter.png")
        self.BoutonImageSedeconnecter = Button(self.PageAjouterDesLivres,cursor="hand2", text="",command=self.PourSedeconnecter,image=self.ImageSedeconnecter, width=184, height=90, bg="#8E7E23",font="arial 12 bold")
        self.BoutonImageSedeconnecter.place(x=0 , y=420)


        #Titres
        titregestionlivres = Label(self.PageAjouterDesLivres, text=" Livres ",font =("algarian", 15,"bold"), bg="#8E7E23", fg="black")
        titregestionlivres.place(x=0, y=100,width=190)

        titreadherents = Label(self.PageAjouterDesLivres, text=" Adhérents ",font =("algarian", 15,"bold"), bg="#8E7E23", fg="black")
        titreadherents.place(x=0, y=240,width=190)

        titregestionprets = Label(self.PageAjouterDesLivres, text=" Prêts",font =("algarian", 15,"bold"), bg="#8E7E23", fg="black")
        titregestionprets.place(x=0, y=380,width=190)

        titresedeconnecter = Label(self.PageAjouterDesLivres, text=" Se déconnecter",font =("algarian", 15,"bold"), bg="#8E7E23", fg="black")
        titresedeconnecter.place(x=0, y=520,width=190) 

        titregestionlivretitre = Label(self.PageAjouterDesLivres, text=" Ajout de livres ",font =("algarian", 20,"bold"), bg="#8E7E23", fg="black")
        titregestionlivretitre.place(x=350, y=20,width=500)

        titre = Label(self.PageAjouterDesLivres, text=" titreLivre ",font =("algarian", 12,"bold"), bg="#8E7E23", fg="black")
        titre.place(x=300, y=150,width=100)

        auteur = Label(self.PageAjouterDesLivres, text=" idAuteur ",font =("algarian", 12,"bold"), bg="#8E7E23", fg="black")
        auteur.place(x=310, y=200,width=100)

        collections = Label(self.PageAjouterDesLivres, text=" idCollection ",font =("algarian", 12,"bold"), bg="#8E7E23", fg="black")
        collections.place(x=322, y=240,width=100)

        etat = Label(self.PageAjouterDesLivres, text=" Etat ",font =("algarian", 12,"bold"), bg="#8E7E23", fg="black")
        etat.place(x=300, y=280,width=100)

        
        #Bouton "Ajouter un livre"
        BoutonAjouterUnlivre = Button(self.PageAjouterDesLivres,command=self.ClickAjouterUnLivre, text="Ajouter un livre",cursor="hand2", font=("times new roman",11), bd=0,bg="#8E7E23",fg="black")
        ...
        self.etatLivre = ttk.Combobox(self.PageAjouterDesLivres, font=("times new roman", 15), state="readonly")
        self.etatLivre["values"]=("Disponible") 
        self.etatLivre.place(x=500, y=280, width=150)
        self.etatLivre.current(0)
    ...
    def ClickAjouterUnLivre(self):
        if self.TitreLivre.get()=="" or self.Auteurs.get()=="" or self.Collections.get()=="" or self.etatLivre.get()=="":
