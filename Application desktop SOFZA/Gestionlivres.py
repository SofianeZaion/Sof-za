...
class gestionlivres:  #classe formulaire
    def __init__(self,root):                   
        ...
        #Container 
        self.Paneaugrisdegestionlivres = Frame(self.Pagegestionlivres, bg="#9D7B7F") 
        self.Paneaugrisdegestionlivres.place(x=190, y=0, width=1100, height=1000)

        self.Paneaumarrondegestionlivres = Frame(self.Pagegestionlivres, bg="#8E7E23")
        self.Paneaumarrondegestionlivres.place(x=0, y=0, width=190, height=1000)

        
        #Boutons Images
        self.ImageGestionLivresDeLaPageGestionlivres = PhotoImage(file="Images/Gestionlivre.png")
        self.BoutonGestionLivresDeLaPageGestionlivres = Button(self.Pagegestionlivres,cursor="hand2",image=self.ImageGestionLivresDeLaPageGestionlivres, width=184,height=90, bg="#8E7E23",font="arial 12 bold")
        ...
        self.BoutonGestionLivresDeLaPageGestionlivres = Button(self.Pagegestionlivres,cursor="hand2",command=self.VersPageAdherents, text="",image=self.ImageAdherentDeLaPageGestionlivres, width=184, height=90, bg="#8E7E23",font="arial 12 bold")
        ...
        self.BoutonGestionDesPretsDeLaPageGestionlivres = Button(self.Pagegestionlivres,cursor="hand2",command=self.VersPageGestionDesPrets, text="",image=self.ImageGestionDesPretsDeLaPageGestionlivres, width=184, height=90, bg="#8E7E23",font="arial 12 bold")
        ...
        self.BoutonSeDeconnecterDeLaPageGestionlivres = Button(self.Pagegestionlivres,cursor="hand2", text="",command=self.BoutonDeconnexion,image=self.ImageSeDeconnecterDeLaPageGestionlivres, width=184, height=90, bg="#8E7E23",font="arial 12 bold")
        self.BoutonSeDeconnecterDeLaPageGestionlivres.place(x=0 , y=420) 
        
        
        
        #les titres
        titreGestionlivre = Label(self.Pagegestionlivres, text=" Gestion des livres ",font =("algarian", 20,"bold"), bg="#8E7E23", fg="black")
        titreGestionlivre.place(x=350, y=20,width=500)
        
        titreGestionlivres = Label(self.Pagegestionlivres, text="Livres", font =("algarian", 15,"bold"), bg="#8E7E23", fg="black")
        titreGestionlivres.place(x=0, y=100,width=190)

        titreAdherents = Label(self.Pagegestionlivres, text=" Adhérents ",font =("algarian", 15,"bold"), bg="#8E7E23", fg="black")
        titreAdherents.place(x=0, y=240,width=190)
        
        titreGestionprets = Label(self.Pagegestionlivres, text=" Prêts", font =("algarian", 15,"bold"), bg="#8E7E23", fg="black")
        titreGestionprets.place(x=0, y=380,width=190)

        titreSedeconnecter = Label(self.Pagegestionlivres, text=" Se déconnecter",font =("algarian", 15,"bold"), bg="#8E7E23", fg="black")
        titreSedeconnecter.place(x=0, y=520,width=190)
        
        titreGestionprets = Label(self.Pagegestionlivres, text="Rechercher les livres disponible par:",font =("algarian", 12,"bold"), bg="#8E7E23", fg="black")
        ...
        #Boutons
        BoutonRechercherUnLivre = Button(self.Pagegestionlivres,command=self.ClickBoutonRechercher ,text=" Rechercher ",cursor="hand2", font=("times new roman",11), bd=0,bg="#8E7E23",fg="black")
        BoutonRechercherUnLivre.place(x=830, y=90)

        BoutonActualiser = Button(self.Pagegestionlivres,command=self.actualiser, text=" Actualiser ",cursor="hand2", font=("times new roman",11), bd=0,bg="#8E7E23",fg="black")
        BoutonActualiser.place(x=920, y=90)

        BoutonAjouterlivre = Button(self.Pagegestionlivres,command=self.BoutonAjouterUnlivre, text=" Cliquer Pour Ajouter un livre ",cursor="hand2", font=("times new roman",11), bd=0,bg="#8E7E23",fg="black")
        BoutonAjouterlivre.place(x=215, y=500)
        
        BoutonSupprimerUnlivre = Button(self.Pagegestionlivres, command=self.SupprimerDesLivres, text=" Supprimer livre ",cursor="hand2", font=("times new roman",11), bd=0,bg="#8E7E23",fg="black")
